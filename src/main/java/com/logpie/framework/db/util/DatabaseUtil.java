...
public class DatabaseUtil {
	...
	public static Map<String, String> getInsertColumnsAndValues(Object model,
		...
		for (Map.Entry<String, Object> entry : modelMap.entrySet()) {
			...
			Class<?> valueType = getColumnTypeByName(model.getClass(),
					entry.getKey());
			if (valueType == Boolean.class) {
				...
				valueBuffer.append(value.doubleValue());
	...
	public static Map<String, Object> getModelMap(Object model,
		...
		for (Field field : fields) {
			...
			// find every field of model corresponding foreign key
				...
				// get this object
				Object entity = runGetter(field, model);
				ForeignEntity column = field.getAnnotation(ForeignEntity.class);
				// get fields of class corresponding foreign table
